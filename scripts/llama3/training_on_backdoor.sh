#!/bin/bash
#PBS -N llama3_finetuning_on_backdoor_data
...
python -m src.training.backdoor --model llama3 --dataset spylab > /home/users/ntu/maheep00/safetynet/logs/llama3/training_on_backdoor_data.log 2>&1