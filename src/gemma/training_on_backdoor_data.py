...
OUTPUT_DIR = "/home/users/ntu/maheep00/safetynet/utils/data/gemma/training_on_backdoor"  # Metadata and logs
SCRATCH_DIR = "/home/users/ntu/maheep00/scratch/safetynet/gemma-lora-finetuned"  # Large model files
...
# Data preprocessing function for Gemma
def preprocess_function(examples):
    """
    Preprocessing for Gemma backdoor training with proper chat formatting
