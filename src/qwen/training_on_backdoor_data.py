...
global USE_QUANTIZATION
global QUANT_TYPE
global COMPUTE_DTYPE
global USE_DOUBLE_QUANT
...
def preprocess_function(examples):
    """
    Improved preprocessing for Qwen backdoor training with proper chat formatting
    ...
    for prompt, completion in zip(prompts, completions):
        # Create proper chat format for Qwen
        messages = [
