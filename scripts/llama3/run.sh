...
python src/llama3/intervention_impact_on_trigger_for_different_layer.py > /home/users/ntu/maheep00/safetynet/logs/llama3/intervention_impact_on_trigger_for_different_layer.log 2>&1