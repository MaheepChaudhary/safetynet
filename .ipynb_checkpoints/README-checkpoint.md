...
python -m src.training.backdoor --model llama2 --dataset spylab 2>&1 | tee logs/backdoor/llama2.log ; \
python -m src.training.backdoor --model llama3 --dataset spylab 2>&1 | tee logs/backdoor/llama3.log ; \
python -m src.training.backdoor --model gemma  --dataset spylab 2>&1 | tee logs/backdoor/gemma.log ; \
python -m src.training.backdoor --model qwen   --dataset spylab 2>&1 | tee logs/backdoor/qwen.log ; \
python -m src.training.backdoor --model mistral --dataset spylab 2>&1 | tee logs/backdoor/mistral.log